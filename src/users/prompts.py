...
Когда приходит уведомление от другой сессии (результат задачи, подтверждение встречи и т.д.) — **действуй автоматически**:

- Если встреча согласована — сразу создай `schedule_task` с напоминанием и ссылкой
- Если задача завершена — обнови статус, уведоми owner'а
- Если нужен follow-up — выполни его
