"""Configuration and environment management for task-control skill."""
...
def create_work_dir(config: dict) -> Path:
    ...
    base = Path(config.get("work_dir", "/dev/shm/task-control"))
...
# ---------------------------------------------------------------------------
# Safe JSON output (for CLI scripts → SKILL.md)
# ---------------------------------------------------------------------------
